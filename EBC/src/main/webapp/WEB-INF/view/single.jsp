...
<<li><a href="#">
 ...
 <div class="row">
    <div class="col-sm-4" >
    <img alt="" src="${req}/resources/images/product/${a.productid}.jpg"height="600px" width="200px" /><br>
   <h2> price:&#8377 ${a.productprice}</h2>

    <a href="${req}/login" class="btn btn-info btn-lg">
